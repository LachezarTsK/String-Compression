...
public:
    ...
    int compress(vector<char>& characters) {
        int left = 0;
        int right = 0;
    ...
    int numberOfDigits(int charFrequency) {
    ...
    void fillArrayWithFrequencyOfCharacter(vector<char>& characters, int charFrequency, int arraySlotsNeededForDigits, int index) {

        int divider = pow(10, arraySlotsNeededForDigits - 1);
